        ...
        taskId:
          schema:
            - type: string
              required: true
              description: >-
                The task ID returned from the Convert to WAV Format endpoint.
                Used to retrieve details about the conversion process, including
                status and download URL if available.
      header: {}
      cookie: {}
    body: {}
  response:
                  ...
                  - type: object
                    properties:
                      ...
                      callbackUrl:
                        type: string
                        description: >-
                          The callback URL that was provided in the conversion
                          request
                      completeTime:
                        type: string
